...
<body>
<!--<div class = "header"> 
            <h2 class = gfg style = "color:white;font-size:200%"> 
                Prime Videos 
            </h2> 
        </div> 
        ...
        <div class = "header1"> 
         ...
         <div></div>   <jsp:include page= "search.jsp"></jsp:include>
        </div>
<%
...
<div class="card" style="width: 15rem; height: 30rem">
 ...
 <div class="card-body">
   <div class = "gfg" ><h6 class="card-text"><centre>PrimeId:<%=cd1.getPrimeId() %></h6></centre></div>
    <div class = "gfg" ><h6 class="card-text"><centre>Genre:<%=cd1.getGenre() %></h6></centre></div>
    <div class = "gfg" ><h6 class="card-number"><centre>IMDB:<%=cd1.getImdbRating()%></h6></centre></div>
         <div class = "gfg" ><h6><i class="fa fa-thumbs-o-up"><%=cd1.getTlikes()%></i>
  <i class="fa fa-thumbs-o-down"><%=cd1.getTdislikes()%></h6></i>
