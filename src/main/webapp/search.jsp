...
<div class = "header"> 
            <h2 style = "color:Green;font-size:200%"> 
                Prime Videos 
            </h2> 
        </div> 
...
<div class="col">
		...
		<label for= "searchterm" ><centre>Search Term</centre></label>
		<br>
		<input type = "text"  name = "searchterm" placeholder = "Search Term" size = 125 requied autofocus/>
		<button class="button"><span>Search </span></button>
		<br>
		<br>
Categorys: <select id="categorys" name="categorys" >
...
IMDB RATING :  <select id="imdbrating" name ="imdbrating">
    <option value="0">ALL</option>
...
<label for= "Director">Director</label>
		...
		<input type = "text1"  name = "Director" placeholder = "Director" size = 25 />

<label for= "Actor">Actor</label>

		<input type = "text1"  name = "Actor" placeholder = "Actor" size = 25 />
<label>
    <input type="checkbox" name="originals"> Prime Originals
  </label>	
</div></div></div>
</form>
</body>